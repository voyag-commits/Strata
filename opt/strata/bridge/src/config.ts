...
function asPort(value: string | undefined, defaultValue: number): number {
...
function asPositiveInt(value: string | undefined, defaultValue: number, field: string): number {
  if (!value) return defaultValue;
  const parsed = Number.parseInt(value, 10);
...
function parseEffort(value: string | undefined): "high" | "max" | undefined {
