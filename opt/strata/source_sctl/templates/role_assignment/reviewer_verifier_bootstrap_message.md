...
Objective: provide prompt, objective verification for a small trunk-bound change against the stated Coordinator Work Order / Required Change Items.

Review discipline:

```text
inspect the diff and stated Definition of Done
compare the implementation against the Coordinator Work Order / Required Change Items
