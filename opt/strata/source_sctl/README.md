...
## Delegate contract alignment

This package version removes the embedded mock runtime and routes live Flowmap 02 runtime operations directly through the external delegate control surface verbs. SCTL owns context, dispatch rendering, return directories, return validation, Class A/B commits, and cycle progression. The delegate owns tmux/Codex session binding, dispatch delivery, capture, and termination.
